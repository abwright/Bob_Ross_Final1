...
mouseY = (e.changedTouches ? e.changedTouches[0].pageY : e.pageY) - this.offsetTop;
		...
		init = function () {
			...
			crayonImage.src = "images/images/crayon-outline.png";

			markerImage.onload = resourceLoaded;
			markerImage.src = "images/images/marker-outline.png";

			eraserImage.onload = resourceLoaded;
			eraserImage.src = "images/images/eraser-outline.png";

			crayonBackgroundImage.onload = resourceLoaded;
			crayonBackgroundImage.src = "images/images/crayon-background.png";

			markerBackgroundImage.onload = resourceLoaded;
			markerBackgroundImage.src = "images/images/marker-background.png";

			eraserBackgroundImage.onload = resourceLoaded;
			eraserBackgroundImage.src = "images/images/eraser-background.png";

			crayonTextureImage.onload = resourceLoaded;
			crayonTextureImage.src = "images/images/crayon-texture.png";

			outlineImage.onload = resourceLoaded;
			outlineImage.src = "images/images/blankcanvas.png";
		};
